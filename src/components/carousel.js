        ...
        <div>
            <div class="relative m-auto">
                <div class="slides fade">
                    ...
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">NEW</p>
                ...
                <div class="slides fade hidden">
                    ...
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Introducing Dijie Shooter</p>
                ...
                <div class="slides fade hidden">
                    ...
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Point. Shoot. Share.</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Through Your Lens</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Make Them Shutter</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Ditch Your SD</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">It Just Clicks</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Zoom In On This</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Light Up The Room</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Your Good Side, Everytime</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Infinite Memories</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Long Social Battery</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">Timeless Design</p>
                ...
                <div class="slides fade hidden">
                    <img src="/images/landing1.png" class="w-[100%]" />
                    <div class="mt-5 mb-5 h-[8vh]">
                        <p class="text-blueAccent text-center font-bold">To Our Friends & Family</p>
